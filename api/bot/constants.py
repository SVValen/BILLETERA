AYUDA = (
    ...
    "  `/mis_portafolios` — ver todos tus portafolios y capital\n"
    "  `/activos` — elegir qué activos RV monitorear en tu portafolio\n"
    ...
    "  `/como_funciona` — cómo se calculan las señales RSI/EMA\n\n"

    "💸 *Sumar capital a un portafolio:*\n"
    "  `sumé 500 USD al conservador`\n"
    "  `agregué 200000 pesos`\n"
    "  `deposité 1000 USD`\n\n"

    "💼 *Renta Fija y Liquidez:*\n"
    "  `/opciones_rf` — instrumentos disponibles con botones para registrar\n"
    "  `/liquidez` — carry trade, posiciones abiertas, P&L en USD\n"
    "  `puse 500000 en caución 7 días` — registrar posición directamente\n"
